...
/*!40000 DROP DATABASE IF EXISTS `broadleaf`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `broadleaf` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
--
-- Table structure for table `FNF_CATEGORY`
--

DROP TABLE IF EXISTS `FNF_CATEGORY`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `FNF_CATEGORY` (
  `CATEGORY_ID` bigint(20) NOT NULL,
  PRIMARY KEY (`CATEGORY_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary table structure for view `FULL_DAY_AVAILABLE`
--

DROP TABLE IF EXISTS `FULL_DAY_AVAILABLE`;
/*!50001 DROP VIEW IF EXISTS `FULL_DAY_AVAILABLE`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `FULL_DAY_AVAILABLE` (
  `Product_ID` tinyint NOT NULL,
  `SKU_ID` tinyint NOT NULL,
  `SKU_INSTANCE_ID` tinyint NOT NULL,
  `DATE` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Table structure for table `ORDERED_SKU`
--

DROP TABLE IF EXISTS `ORDERED_SKU`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ORDERED_SKU` (
  `ID` bigint(20) NOT NULL,
  `MRP` decimal(19,2) DEFAULT NULL,
  `SECONDARY` tinyint(1) DEFAULT NULL,
  `SECURITY` decimal(19,2) DEFAULT NULL,
  `SELECTED` tinyint(1) DEFAULT NULL,
  `ORDER_ITEM_ID` bigint(20) DEFAULT NULL,
  `SKU_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `FKFF60060BF8E2BC16` (`ORDER_ITEM_ID`),
  KEY `FKFF60060BBE384F4D` (`SKU_ID`),
  CONSTRAINT `FKFF60060BBE384F4D` FOREIGN KEY (`SKU_ID`) REFERENCES `RENTABLE_SKU` (`SKU_ID`),
  CONSTRAINT `FKFF60060BF8E2BC16` FOREIGN KEY (`ORDER_ITEM_ID`) REFERENCES `RENT_DISCRETE_ORDER_ITEM` (`ORDER_ITEM_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ORDER_EVENT` (
  `ID` bigint(20) NOT NULL,
  `CANCELLATION_CHARGES` decimal(19,2) DEFAULT NULL,
  `Comment` varchar(255) DEFAULT NULL,
  `DATE_CREATED` datetime DEFAULT NULL,
  `EVENT` varchar(255) DEFAULT NULL,
  `ORDER_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `FK2BC7D22944AFB9B2` (`ORDER_ID`),
  CONSTRAINT `FK2BC7D22944AFB9B2` FOREIGN KEY (`ORDER_ID`) REFERENCES `RENT_ORDER` (`ORDER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Temporary table structure for view `PRODUCT_AVAILABILITY_FOR_EVENT`
--

DROP TABLE IF EXISTS `PRODUCT_AVAILABILITY_FOR_EVENT`;
/*!50001 DROP VIEW IF EXISTS `PRODUCT_AVAILABILITY_FOR_EVENT`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `PRODUCT_AVAILABILITY_FOR_EVENT` (
  `PRODUCT_ID` tinyint NOT NULL,
  `DATE` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Table structure for table `PRODUCT_BLOCKING`
--

DROP TABLE IF EXISTS `PRODUCT_BLOCKING`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `PRODUCT_BLOCKING` (
  `ID` bigint(20) NOT NULL,
  `DATE` date NOT NULL,
  `TIME_SLOT` varchar(255) NOT NULL,
  `ORDERED_SKU_ID` bigint(20) DEFAULT NULL,
  `SKU_INSTANCE_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `FKE7AADA522AED2AE` (`ORDERED_SKU_ID`),
  KEY `FKE7AADA54951E57B` (`SKU_INSTANCE_ID`),
  CONSTRAINT `FKE7AADA522AED2AE` FOREIGN KEY (`ORDERED_SKU_ID`) REFERENCES `ORDERED_SKU` (`ID`),
  CONSTRAINT `FKE7AADA54951E57B` FOREIGN KEY (`SKU_INSTANCE_ID`) REFERENCES `SKU_INSTANCE` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `PRODUCT_BUNDLE_EXTENSION`
--

DROP TABLE IF EXISTS `PRODUCT_BUNDLE_EXTENSION`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `PRODUCT_BUNDLE_EXTENSION` (
  `RENT_ALLOWED` tinyint(1) DEFAULT NULL,
  `SELL_ALLOWED` tinyint(1) DEFAULT NULL,
  `PRODUCT_ID` bigint(20) NOT NULL,
  PRIMARY KEY (`PRODUCT_ID`),
  KEY `FK488EF212851D6359` (`PRODUCT_ID`),
  CONSTRAINT `FK488EF212851D6359` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `BLC_PRODUCT_BUNDLE` (`PRODUCT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PRODUCT_EXTENSION` (
  ...
  `PRODUCT_ID` bigint(20) NOT NULL,
  PRIMARY KEY (`PRODUCT_ID`),
  KEY `FK684E08AF5F11A0B7` (`PRODUCT_ID`),
  CONSTRAINT `FK684E08AF5F11A0B7` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `BLC_PRODUCT` (`PRODUCT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Temporary table structure for view `PRODUCT_SLOT_AVAILABILITY`
--

DROP TABLE IF EXISTS `PRODUCT_SLOT_AVAILABILITY`;
/*!50001 DROP VIEW IF EXISTS `PRODUCT_SLOT_AVAILABILITY`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `PRODUCT_SLOT_AVAILABILITY` (
  `PRODUCT_ID` tinyint NOT NULL,
...
CREATE TABLE `REFUND` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FK8FDAD37844AFB9B2` (`ORDER_ID`),
  KEY `FK8FDAD3783C72964C` (`ORDER_EVENT_ID`),
  CONSTRAINT `FK8FDAD3783C72964C` FOREIGN KEY (`ORDER_EVENT_ID`) REFERENCES `ORDER_EVENT` (`ID`),
  CONSTRAINT `FK8FDAD37844AFB9B2` FOREIGN KEY (`ORDER_ID`) REFERENCES `RENT_ORDER` (`ORDER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `RENTABLE_PRODUCT`
--

DROP TABLE IF EXISTS `RENTABLE_PRODUCT`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `RENTABLE_PRODUCT` (
  `CUSTOMIZABLE` tinyint(1) NOT NULL,
  `PRODUCT_ID` bigint(20) NOT NULL,
  PRIMARY KEY (`PRODUCT_ID`),
  KEY `FK5A7D8A3C62E06B8` (`PRODUCT_ID`),
  CONSTRAINT `FK5A7D8A3C62E06B8` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `PRODUCT_EXTENSION` (`PRODUCT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `RENTABLE_SKU`
--

DROP TABLE IF EXISTS `RENTABLE_SKU`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `RENTABLE_SKU` (
  `SKU_ID` bigint(20) NOT NULL,
  `MRP` decimal(19,2) DEFAULT NULL,
  `SECURITY_AMOUNT` decimal(19,2) DEFAULT NULL,
  PRIMARY KEY (`SKU_ID`),
  KEY `FK3690CAD1B78C9977` (`SKU_ID`),
  CONSTRAINT `FK3690CAD1B78C9977` FOREIGN KEY (`SKU_ID`) REFERENCES `BLC_SKU` (`SKU_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `RENT_DISCRETE_ORDER_ITEM`
--

DROP TABLE IF EXISTS `RENT_DISCRETE_ORDER_ITEM`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `RENT_DISCRETE_ORDER_ITEM` (
  `MRP` decimal(19,5) DEFAULT NULL,
  `SECURITY` decimal(19,5) DEFAULT NULL,
  `TIME_SLOT` varchar(255) DEFAULT NULL,
  `TRIAL_DATE` date DEFAULT NULL,
  `ORDER_ITEM_ID` bigint(20) NOT NULL,
  PRIMARY KEY (`ORDER_ITEM_ID`),
  KEY `FK3682DC84B76B9466` (`ORDER_ITEM_ID`),
  CONSTRAINT `FK3682DC84B76B9466` FOREIGN KEY (`ORDER_ITEM_ID`) REFERENCES `BLC_DISCRETE_ORDER_ITEM` (`ORDER_ITEM_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `RENT_ORDER` (
  `DAMAGE_CLAIMED` decimal(19,2) DEFAULT NULL,
  `EVENT_DATE` datetime DEFAULT NULL,
  `REFUNDABLE` decimal(19,2) DEFAULT NULL,
  `TOTAL_AMOUNT` decimal(19,2) DEFAULT NULL,
  `TOTAL_SECURITY` decimal(19,2) DEFAULT NULL,
  `ORDER_ID` bigint(20) NOT NULL,
  PRIMARY KEY (`ORDER_ID`),
  KEY `FKDEBB36A889FE8A02` (`ORDER_ID`),
  CONSTRAINT `FKDEBB36A889FE8A02` FOREIGN KEY (`ORDER_ID`) REFERENCES `BLC_ORDER` (`ORDER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Temporary table structure for view `SKU_AVAILABILITY_FOR_EVENT`
--

DROP TABLE IF EXISTS `SKU_AVAILABILITY_FOR_EVENT`;
/*!50001 DROP VIEW IF EXISTS `SKU_AVAILABILITY_FOR_EVENT`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `SKU_AVAILABILITY_FOR_EVENT` (
  `SKU_ID` tinyint NOT NULL,
  `SKU_INSTANCE_ID` tinyint NOT NULL,
  `DATE` tinyint NOT NULL
) ENGINE=MyISAM */;
...
--
-- Table structure for table `SKU_INSTANCE`
--

DROP TABLE IF EXISTS `SKU_INSTANCE`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `SKU_INSTANCE` (
  `ID` bigint(20) NOT NULL,
  `ADVANCE_BOOKING_LIMIT` bigint(20) NOT NULL,
  `INSTANCE_ID` bigint(20) DEFAULT NULL,
  `SELLABLE` tinyint(1) DEFAULT NULL,
  `TIMES_RENTED` bigint(20) DEFAULT NULL,
  `TIMES_TRIED` bigint(20) DEFAULT NULL,
  `SKU_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `FK8F1D4197BE384F4D` (`SKU_ID`),
  CONSTRAINT `FK8F1D4197BE384F4D` FOREIGN KEY (`SKU_ID`) REFERENCES `RENTABLE_SKU` (`SKU_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `SKU_INSTANCE_AVAILABILITY`
--

DROP TABLE IF EXISTS `SKU_INSTANCE_AVAILABILITY`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `SKU_INSTANCE_AVAILABILITY` (
  `ID` bigint(20) NOT NULL,
  `AVAILABLE` tinyint(1) DEFAULT NULL,
  `BLOCKED_BY_VENDOR` tinyint(1) DEFAULT NULL,
  ...
  `SKU_INSTANCE_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `FKB5D4B3031AA27B8D` (`PRODUCT_ID`),
  KEY `FKB5D4B303BE384F4D` (`SKU_ID`),
  KEY `FKB5D4B3034951E57B` (`SKU_INSTANCE_ID`),
  CONSTRAINT `FKB5D4B3031AA27B8D` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `RENTABLE_PRODUCT` (`PRODUCT_ID`),
  CONSTRAINT `FKB5D4B3034951E57B` FOREIGN KEY (`SKU_INSTANCE_ID`) REFERENCES `SKU_INSTANCE` (`ID`),
  CONSTRAINT `FKB5D4B303BE384F4D` FOREIGN KEY (`SKU_ID`) REFERENCES `RENTABLE_SKU` (`SKU_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Temporary table structure for view `SKU_INSTANCE_AVAILABILITY_FOR_EVENT`
--

DROP TABLE IF EXISTS `SKU_INSTANCE_AVAILABILITY_FOR_EVENT`;
/*!50001 DROP VIEW IF EXISTS `SKU_INSTANCE_AVAILABILITY_FOR_EVENT`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `SKU_INSTANCE_AVAILABILITY_FOR_EVENT` (
  `PRODUCT_ID` tinyint NOT NULL,
  `SKU_ID` tinyint NOT NULL,
  `SKU_INSTANCE_ID` tinyint NOT NULL,
  `DATE` tinyint NOT NULL
...
--
-- Temporary table structure for view `SKU_SLOT_AVAILABILITY`
--

DROP TABLE IF EXISTS `SKU_SLOT_AVAILABILITY`;
/*!50001 DROP VIEW IF EXISTS `SKU_SLOT_AVAILABILITY`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `SKU_SLOT_AVAILABILITY` (
  `SKU_ID` tinyint NOT NULL,
  `SKU_INSTANCE_ID` tinyint NOT NULL,
  `SLOTID` tinyint NOT NULL
) ENGINE=MyISAM */;
...
--
-- Final view structure for view `FULL_DAY_AVAILABLE`
--

/*!50001 DROP TABLE IF EXISTS `FULL_DAY_AVAILABLE`*/;
/*!50001 DROP VIEW IF EXISTS `FULL_DAY_AVAILABLE`*/;
...
/*!50013 DEFINER=`fnf`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `FULL_DAY_AVAILABLE` AS (select `SKU_INSTANCE_AVAILABILITY`.`PRODUCT_ID` AS `Product_ID`,`SKU_INSTANCE_AVAILABILITY`.`SKU_ID` AS `SKU_ID`,`SKU_INSTANCE_AVAILABILITY`.`SKU_INSTANCE_ID` AS `SKU_INSTANCE_ID`,`SKU_INSTANCE_AVAILABILITY`.`DATE` AS `DATE` from `SKU_INSTANCE_AVAILABILITY` group by `SKU_INSTANCE_AVAILABILITY`.`PRODUCT_ID`,`SKU_INSTANCE_AVAILABILITY`.`SKU_ID`,`SKU_INSTANCE_AVAILABILITY`.`SKU_INSTANCE_ID`,`SKU_INSTANCE_AVAILABILITY`.`DATE` having (sum(`SKU_INSTANCE_AVAILABILITY`.`AVAILABLE`) = count(0))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `PRODUCT_AVAILABILITY_FOR_EVENT`
--

/*!50001 DROP TABLE IF EXISTS `PRODUCT_AVAILABILITY_FOR_EVENT`*/;
/*!50001 DROP VIEW IF EXISTS `PRODUCT_AVAILABILITY_FOR_EVENT`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`fnf`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `PRODUCT_AVAILABILITY_FOR_EVENT` AS (select `SKU_INSTANCE_AVAILABILITY_FOR_EVENT`.`PRODUCT_ID` AS `PRODUCT_ID`,`SKU_INSTANCE_AVAILABILITY_FOR_EVENT`.`DATE` AS `DATE` from `SKU_INSTANCE_AVAILABILITY_FOR_EVENT` group by `SKU_INSTANCE_AVAILABILITY_FOR_EVENT`.`PRODUCT_ID`,`SKU_INSTANCE_AVAILABILITY_FOR_EVENT`.`DATE`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `PRODUCT_SLOT_AVAILABILITY`
--

/*!50001 DROP TABLE IF EXISTS `PRODUCT_SLOT_AVAILABILITY`*/;
/*!50001 DROP VIEW IF EXISTS `PRODUCT_SLOT_AVAILABILITY`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`fnf`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `PRODUCT_SLOT_AVAILABILITY` AS (select `SKU_INSTANCE_AVAILABILITY`.`PRODUCT_ID` AS `PRODUCT_ID`,cast(concat(date_format(`SKU_INSTANCE_AVAILABILITY`.`DATE`,'%Y%m%d'),(case `SKU_INSTANCE_AVAILABILITY`.`TIME_SLOT` when 'Morning' then '1' when 'AfterNoon' then '2' when 'Evening' then '3' end)) as unsigned) AS `SLOTID` from `SKU_INSTANCE_AVAILABILITY` where (`SKU_INSTANCE_AVAILABILITY`.`AVAILABLE` = 1) group by `SKU_INSTANCE_AVAILABILITY`.`PRODUCT_ID`,`SKU_INSTANCE_AVAILABILITY`.`DATE`,`SKU_INSTANCE_AVAILABILITY`.`TIME_SLOT` having (sum(`SKU_INSTANCE_AVAILABILITY`.`AVAILABLE`) > 0)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `SKU_AVAILABILITY_FOR_EVENT`
--

/*!50001 DROP TABLE IF EXISTS `SKU_AVAILABILITY_FOR_EVENT`*/;
/*!50001 DROP VIEW IF EXISTS `SKU_AVAILABILITY_FOR_EVENT`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`fnf`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `SKU_AVAILABILITY_FOR_EVENT` AS (select `SKU_INSTANCE_AVAILABILITY_FOR_EVENT`.`SKU_ID` AS `SKU_ID`,max(`SKU_INSTANCE_AVAILABILITY_FOR_EVENT`.`SKU_INSTANCE_ID`) AS `SKU_INSTANCE_ID`,`SKU_INSTANCE_AVAILABILITY_FOR_EVENT`.`DATE` AS `DATE` from `SKU_INSTANCE_AVAILABILITY_FOR_EVENT` group by `SKU_INSTANCE_AVAILABILITY_FOR_EVENT`.`SKU_ID`,`SKU_INSTANCE_AVAILABILITY_FOR_EVENT`.`DATE`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `SKU_INSTANCE_AVAILABILITY_FOR_EVENT`
--

/*!50001 DROP TABLE IF EXISTS `SKU_INSTANCE_AVAILABILITY_FOR_EVENT`*/;
/*!50001 DROP VIEW IF EXISTS `SKU_INSTANCE_AVAILABILITY_FOR_EVENT`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`fnf`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `SKU_INSTANCE_AVAILABILITY_FOR_EVENT` AS (select distinct `FCUR`.`Product_ID` AS `PRODUCT_ID`,`FCUR`.`SKU_ID` AS `SKU_ID`,`FCUR`.`SKU_INSTANCE_ID` AS `SKU_INSTANCE_ID`,`FCUR`.`DATE` AS `DATE` from ((`FULL_DAY_AVAILABLE` `FCUR` join `FULL_DAY_AVAILABLE` `FPREV` on(((`FCUR`.`SKU_INSTANCE_ID` = `FPREV`.`SKU_INSTANCE_ID`) and ((`FCUR`.`DATE` = curdate()) or (`FCUR`.`DATE` = (`FPREV`.`DATE` + interval 1 day)))))) join `FULL_DAY_AVAILABLE` `FNEXT` on(((`FCUR`.`SKU_INSTANCE_ID` = `FNEXT`.`SKU_INSTANCE_ID`) and (`FNEXT`.`DATE` = (`FCUR`.`DATE` + interval 1 day)))))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `SKU_SLOT_AVAILABILITY`
--

/*!50001 DROP TABLE IF EXISTS `SKU_SLOT_AVAILABILITY`*/;
/*!50001 DROP VIEW IF EXISTS `SKU_SLOT_AVAILABILITY`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`fnf`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `SKU_SLOT_AVAILABILITY` AS (select `SKU_INSTANCE_AVAILABILITY`.`SKU_ID` AS `SKU_ID`,max(`SKU_INSTANCE_AVAILABILITY`.`SKU_INSTANCE_ID`) AS `SKU_INSTANCE_ID`,cast(concat(date_format(`SKU_INSTANCE_AVAILABILITY`.`DATE`,'%Y%m%d'),(case `SKU_INSTANCE_AVAILABILITY`.`TIME_SLOT` when 'Morning' then '1' when 'AfterNoon' then '2' when 'Evening' then '3' end)) as unsigned) AS `SLOTID` from `SKU_INSTANCE_AVAILABILITY` where (`SKU_INSTANCE_AVAILABILITY`.`AVAILABLE` = 1) group by `SKU_INSTANCE_AVAILABILITY`.`SKU_ID`,`SKU_INSTANCE_AVAILABILITY`.`DATE`,`SKU_INSTANCE_AVAILABILITY`.`TIME_SLOT` having (sum(`SKU_INSTANCE_AVAILABILITY`.`AVAILABLE`) > 0)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2016-08-18 15:54:24
